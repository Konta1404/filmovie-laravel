    ...
    export default {
        ...
        methods: {
                ...
                Vue.axios.get('/api/actors')
                    .then(response => {
                        ...
                        for (let i = 0; i < this.actors.length; i++) {
                            this.actors[i].created_at = moment(this.actors[i].created_at).format('YYYY-MM-DD');
                            this.actors[i].updated_at = moment(this.actors[i].updated_at).format('YYYY-MM-DD');
                        }
                    });
            },
            showModal(){
                this.resetModal();
                this.form = this.actorItem;
            },
            checkFormValidity() {
            ...
            handleSubmit() {
                ...
                Vue.axios.put('/api/actors/' + this.actorItem.id, this.form)
                    .then(res => {
                        new Noty({
